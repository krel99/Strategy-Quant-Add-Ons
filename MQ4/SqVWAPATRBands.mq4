...
int init()
  {
   ...
   IndicatorShortName("SqVWAPYATRBands("+VWAPPeriod+";"+Multiplication+")");
   
   
   SetIndexLabel(0,"VWAP Upper");
   SetIndexLabel(1,"VWAP Lower");
   ...
   for(i=limit; i>=0; i--)
     {
      ...
      double atrValue =  iATR(NULL,0,VWAPPeriod,i);
      
     Upper[i] = IndiBuffer[i]+atrValue*Multiplication;  
     Lower[i] = IndiBuffer[i]-atrValue*Multiplication;
